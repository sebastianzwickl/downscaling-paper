...
figtop.annotate(
    'High heat density areas (e.g., Salzburg)',
    fontsize=5,
    color="#A1B57D",
    multialignment='left',
    va="top",
    xy=(5, 32), xycoords='data',
    xytext=(20, 37), textcoords='data',
...
fig.suptitle('Heat density of district heating in LAUs '+r"in $\frac{GWh}{km^2}$", y=0.925)
