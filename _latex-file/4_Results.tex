...
\begin{table} \centering
	...
	\begin{tabular}{clcccccccc}
		...
		\bottomrule
	\end{tabular}}
	\caption{Heat generation by source in TWh covering the low temperature heat supply in Austria for \SI{2050}{} and the four different storylines. Values obtained from the H2020 project openENTRANCE and GENeSYS-MOD.}
	\label{tab:1}
\end{table}
