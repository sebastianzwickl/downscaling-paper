...
\begin{abstract}
	\added{Fulfilling the goals of the Paris Agreement and limiting anthropogenic climate change}\deleted{Achieving the 1.5°C climate target} requires\deleted{, among others,} a sustainable transformation of the heat\added{ing} \replaced{sector}{supply}. We downscale \replaced{cost-effective heat supply of}{different} European decarbonization scenarios \deleted{of the heating sector }to the Austrian \replaced{community}{municipal} level, using tailor-made downscaling techniques accounting for infrastructure requirements of renewable heat sources and the topology of \replaced{district heating}{centralized heat} networks. \deleted{We demonstrate that allocating district heating networks as part of the downscaling from national results to a local resolution is crucial for a cost-effective and efficient decarbonized heat supply in Austria in 2050.} We \replaced{find}{identify} potential for \replaced{four}{eight} \replaced{decarbonized}{different} district\deleted{s} \added{heating networks in Austria in 2050}\deleted{with centralized heating networks, supplying heat demand between 0.6 and 12TWh}. \replaced{Not all of these networks}{Nevertheless, seven of these networks do not} reach the heat density required for economic and technical efficiency from today's techno-economic perspective and industry benchmarks. \replaced{However, the identified heat density gap can be reduced by an increased allocation of (large-scale) heat pump generation feeding into district heating.}{We conclude that the decarbonization leads to centralized heat networks with lower heat densities.}
\end{abstract}
