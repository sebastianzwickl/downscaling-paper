...
\begin{table}[h] \centering
	...
	\begin{tabular}{clcccccccc}
		...
		\bottomrule
	\end{tabular}}
	\caption{Heat generation by source in TWh, supplying residential and commercial heat demands in Austria 2050 for the different scenarios. Values obtained from the H2020 project openENTRANCE and GENeSYS-MOD.}
	\label{tab:1}
\end{table}
