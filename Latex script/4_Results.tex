...
% ich würde vl die szenario-beschreibung in "data and methodology" geben; ich glaub dort würde es vl besser passen? 
% vl auch die NUTS-Beschreibung? 
...
% ich würde hierzu eine Tabelle erstellen mit den Spalten  "Scenario" und "Description" - das spart dir Text und lange Erklärungssätze | ist aber wirklich
...
% Vl könntest du hier eine zweite x-Achse mit Iterationsschritten einfügen, damit für den Leser verständlich ist dass das die Entwicklung mit jeder Iteration ist 
\begin{sidewaysfigure}
	\centering
